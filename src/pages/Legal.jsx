...
const Legal = ({ type }) => {
    ...
    const content = {
        privacy: {
            ...
            text: (
                <>
                    <p className="mb-6 font-semibold">At Insyver Technologies (OPC) Pvt. Ltd., accessible from www.insyvertechnologies.com, we value your privacy and are committed to protecting your personal data.</p>
                    <p className="mb-8">This Privacy Policy outlines how we collect, use, store, and protect your information when you interact with our website, services, or communications.</p>

                    <h3 className={`text-xl font-bold mb-4 ${isDark ? 'text-white' : 'text-slate-900'}`}>1. Information We Collect</h3>
                    <h4 className={`text-lg font-semibold mb-2 ${isDark ? 'text-slate-200' : 'text-slate-800'}`}>a. Personal Information</h4>
                    <p className="mb-2">We may collect personal data when you:</p>
                    <ul className="list-disc pl-6 mb-4 space-y-1">
                        <li>Fill out a contact form or inquiry</li>
                        <li>Subscribe to newsletters or updates</li>
                        <li>Request a quote or consultation</li>
                    </ul>
                    <p className="mb-4">Collected Data Includes: Full name, Email address, Phone number, Company name and designation, Business requirements or message content.</p>

                    <h4 className={`text-lg font-semibold mb-2 ${isDark ? 'text-slate-200' : 'text-slate-800'}`}>b. Technical Information</h4>
                    <p className="mb-4">Automatically collected when you use our site: IP address, browser details, OS, and usage metrics.</p>

                    <h3 className={`text-xl font-bold mb-4 mt-8 ${isDark ? 'text-white' : 'text-slate-900'}`}>2. How We Use Your Information</h3>
                    <p className="mb-4">We use collected information for: Service delivery, Communication, Improving our website, Marketing (with consent), and Legal compliance.</p>

                    <h3 className={`text-xl font-bold mb-4 mt-8 ${isDark ? 'text-white' : 'text-slate-900'}`}>3. How We Protect Your Data</h3>
                    <p className="mb-4">We implement industry-standard security measures: SSL encryption, Firewalls, Periodic security audits, and strict access controls.</p>

                    <h3 className={`text-xl font-bold mb-4 mt-8 ${isDark ? 'text-white' : 'text-slate-900'}`}>4. Cookies and Tracking</h3>
                    <p className="mb-4">We use cookies to enhance user experience and analytics. You can manage cookies in your browser settings.</p>

                    <h3 className={`text-xl font-bold mb-4 mt-8 ${isDark ? 'text-white' : 'text-slate-900'}`}>Contact Us</h3>
                    <p>If you have questions about privacy, reach us at: <br /><strong>Email:</strong> info@insyvertechnologies.com <br /><strong>Address:</strong> P. NO-02, Laxman Vihar, Phase II, New Colony, Gurgaon-122001, Haryana</p>
                </>
            )
        },
        terms: {
            ...
            text: (
                <>
                    <p className="mb-6">Welcome to Insyver Technologies (OPC) Pvt. Ltd. By accessing or using our website, products, or services, you agree to the following terms and conditions.</p>

                    <h3 className={`text-xl font-bold mb-4 ${isDark ? 'text-white' : 'text-slate-900'}`}>1. Acceptance of Terms</h3>
                    <p className="mb-6">Your use of our website or services signifies your agreement to comply with these Terms of Service. If you do not agree, please discontinue use immediately.</p>

                    <h3 className={`text-xl font-bold mb-4 ${isDark ? 'text-white' : 'text-slate-900'}`}>2. Scope of Services</h3>
                    <p className="mb-6">We offer ICT, Cloud, Cybersecurity, Web Development, and Consulting services. Each engagement is governed by a mutually signed Service Agreement.</p>

                    <h3 className={`text-xl font-bold mb-4 ${isDark ? 'text-white' : 'text-slate-900'}`}>3. User Responsibilities</h3>
                    <p className="mb-6">You agree to provide accurate information and refrain from misuse, hacking, or illegal use of our platforms.</p>

                    <h3 className={`text-xl font-bold mb-4 ${isDark ? 'text-white' : 'text-slate-900'}`}>4. Payment Terms</h3>
                    <ul className="list-disc pl-6 mb-6 space-y-1">
                        <li>Payments follow the agreed-upon schedule.</li>
                        <li>Invoices payable within 30 days.</li>
                        <li>Late payments may incur interest.</li>
                    </ul>

                    <h3 className={`text-xl font-bold mb-4 ${isDark ? 'text-white' : 'text-slate-900'}`}>5. Intellectual Property</h3>
                    <p className="mb-6">All materials produced by Insyver Technologies remain our property unless explicitly transferred via contract.</p>

                    <h3 className={`text-xl font-bold mb-4 ${isDark ? 'text-white' : 'text-slate-900'}`}>6. Governing Law</h3>
                    <p className="mb-6">These terms are governed by the laws of India, with jurisdiction in Gurgaon, Haryana.</p>

                    <p><strong>Contact for Legal Queries:</strong> info@insyvertechnologies.com</p>
                </>
            )
        },
        cookies: {
            ...
            text: (
                <>
                    <p className="mb-6">At Insyver Technologies, we use cookies to improve website functionality, enhance user experience, and analyze traffic.</p>

                    <h3 className={`text-xl font-bold mb-4 ${isDark ? 'text-white' : 'text-slate-900'}`}>1. What Are Cookies?</h3>
                    <p className="mb-6">Cookies are small text files stored on your browser when you visit our site. They help remember preferences and ensure smooth operation.</p>

                    <h3 className={`text-xl font-bold mb-4 ${isDark ? 'text-white' : 'text-slate-900'}`}>2. Types of Cookies We Use</h3>
                    <ul className="list-disc pl-6 mb-6 space-y-2">
                        <li><strong>Essential Cookies:</strong> Required for core functionality (e.g., security, navigation).</li>
                    ...
                    <h3 className={`text-xl font-bold mb-4 ${isDark ? 'text-white' : 'text-slate-900'}`}>3. Managing Cookies</h3>
                    <p className="mb-6">You can manage or disable cookies in your browser settings. However, disabling essential cookies may impact website functionality.</p>

                    <p>For any cookie concerns, contact: info@insyvertechnologies.com</p>
                </>
            )
        }
    };
    ...
    return (
        <div className={`min-h-screen pt-32 pb-20 px-4 animate-page-enter ${isDark ? 'bg-slate-950' : 'bg-gray-50'}`}>
            <div className={`max-w-4xl mx-auto rounded-3xl shadow-xl overflow-hidden transition-colors duration-500 ${isDark ? 'bg-slate-900 border border-slate-800' : 'bg-white border border-slate-100'
                }`}>
                <div className="p-8 md:p-16">
                    <div className="text-center mb-12">
                        <h1 className={`text-3xl md:text-5xl font-bold mb-3 tracking-tight ${isDark ? 'text-white' : 'text-slate-900'}`}>
                            {activeContent.title}
                        </h1>
                        <p className={`text-sm md:text-base font-medium uppercase tracking-wider ${isDark ? 'text-slate-400' : 'text-slate-500'}`}>
                            Last Updated: {activeContent.lastUpdated}
                        </p>
                    </div>

                    <div className={`prose max-w-none leading-loose ${isDark ? 'text-slate-300' : 'text-slate-600'}`}>
                        {activeContent.text}
                    </div>
                </div>
            </div>
